        ...
        <div className="relative w-screen h-screen overflow-hidden bg-[#d4d7db] select-none">
            ...
            {!isComplete && (
                ...
                `,
                    ...
                    <div
                        className={`absolute inset-0 flex items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.7,0,0.3,1)] ${isExiting ? 'scale-75 opacity-0' : 'scale-100 opacity-100'
                            }`}
                    >
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-4 py-2.5 rounded-full bg-white/80 border border-black/10 backdrop-blur-xl shadow-xl">
                ...
                {[
                    ...
                    <button
                        ...
                        className={`px-3.5 py-1.5 rounded-full text-[10px] tracking-[0.15em] uppercase font-mono transition-all duration-300 cursor-pointer ${styleType === item.id && !isComplete
